                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="reset" class="btn-2" style="text-decoration: none; background-color: #cad1f7; "value="Reset">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <p >Already have an account? <a href="login.php" style="color:#7857fe;" >Login here</a>.</p>
                                                        </div>   
                                                    </div>
                                                </div>
                                            </div>
